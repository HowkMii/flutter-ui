    ...
    return Scaffold(
      ...
      body:ListView(
        children: [
          ...
          CarouselSlider(
            //1st methode
            options: CarouselOptions(height: 186,initialPage:0 ,enlargeCenterPage: true, autoPlay: true, autoPlayAnimationDuration: Duration(seconds:1 ), enableInfiniteScroll: false),
